...
other_countries_blog_posts = Blueprint('other_countries_blog_posts',__name__)


@other_countries_blog_posts.route('/other_countries/create', methods=['GET', 'POST'])
@login_required
def create_post():
    form = BlogPostForm()
    country="Others"
...
@other_countries_blog_posts.route('/other_countries/<blog_validated_id>/add_project', methods=['GET', 'POST'])
@login_required
...
# View blog post
@other_countries_blog_posts.route('/other_countries/<int:blog_validated_id>', methods=['GET',
...
# Update
@other_countries_blog_posts.route('/other_countries/<int:blog_validated_id>/update', methods=['GET', 'POST'])
@login_required
...
# Delete
@other_countries_blog_posts.route('/other_countries/<int:blog_validated_id>/delete', methods=['GET', 'POST'])
@login_required
...
@other_countries_blog_posts.route('/other_countries/<int:blog_validated_id>/<int:blog_info_id>/update', methods=['GET', 'POST'])
@login_required
...
@other_countries_blog_posts.route('/other_countries/<int:blog_validated_id>/<int:blog_info_id>/delete', methods=['GET', 'POST'])
@login_required
...
@other_countries_blog_posts.route('/other_countries/<int:blog_validated_id>/<int:blog_idea_id>/delete_idea', methods=['GET', 'POST'])
@login_required
...
@other_countries_blog_posts.route('/other_countries/<int:blog_validated_id>/<int:blog_idea_id>/update_idea', methods=['GET', 'POST'])
@login_required
...
@other_countries_blog_posts.route('/other_countries/<int:blog_validated_id>/<blog_project_id>/update_project', methods=['GET', 'POST'])
@login_required
...
@other_countries_blog_posts.route('/other_countries/<int:blog_validated_id>/<blog_project_id>/delete_project', methods=['GET', 'POST'])
@login_required
